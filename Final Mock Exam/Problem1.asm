...
MAIN:    
    ...
    LDI R21, 125           ; Load counter value for 0.5-second

LOOP:
    SBIC PIND, 5           ; Skip next instruction if bit 4 of PIND is clear (switch pressed)
...
PIN_SETUP:
    ...
    CBI DDRD, 5            ; Set PD5 as input (Switch)
    SBI PORTD, 5           ; Enable pull-up resistor on PD4
    RET                    ; Return from subroutine

; Subroutine to configure Timer0
TIMER0_SETUP:
    LDI R20, 0xC2          ; Load initial value for Timer0
...
T0_OV_ISR:
    ...
    LDI R21, 125          ; Reset counter for 0.5-second cycle
...
HERE: 
    LDI R18, 0xC2         ; Reload initial Timer0 value
